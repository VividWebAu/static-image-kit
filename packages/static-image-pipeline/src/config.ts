    ...
    try {
      ...
      if (resolved && typeof resolved === 'object') {
        return {
          ...
          ...resolved,
          widths: Array.isArray(resolved.widths) ? resolved.widths : DEFAULT_STATIC_IMAGE_CONFIG.widths,
          formats: Array.isArray(resolved.formats) ? resolved.formats : DEFAULT_STATIC_IMAGE_CONFIG.formats,
        };
      }
    } catch {
